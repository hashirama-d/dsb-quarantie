...
class __TwigTemplate_dab38c05950cc110ffb83f8e495dfd8e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    public function block_slick_arrow($context, array $blocks = [])
    {
        ...
        // line 67
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_striptags(t($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "prevArrow", [], "any", false, false, true, 67), 67, $this->source))), "html", null, true);
        echo "\" tabindex=\"0\">";
...
($context["settings"] ?? null), "downArrowOffset", [], "any", false, false, true, 73)], "method", false, false, true, 72), 73, $this->source), "html", null, true);
        ...
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_striptags(t($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "nextArrow", [], "any", false, false, true, 75), 75, $this->source))), "html", null, true);
        echo "\" tabindex=\"0\">";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick.html.twig", "/var/www/web/modules/contrib/slick/templates/slick.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 31, "if" => 55, "block" => 59);
        static $filters = array("join" => 34, "clean_class" => 35, "escape" => 54, "striptags" => 67, "t" => 67);
